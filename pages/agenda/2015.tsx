...
const Agenda2015: React.FC<AgendaPageParameters & { sessions: Session[] }> = ({ sessions }) => {
  const date = zonedTimeToUtc('2015-08-29T08:30', '+08:00')
            ...
            >
              ...
              <StyledAgendaContainer>
                ...
                <StyledAgendaRow tracks={agendaParams.numTracks}>
                  <AgendaTime time={set(date, { hours: 10, minutes: 20 })} />
                ...
                <StyledAgendaRow tracks={agendaParams.numTracks}>
                  <AgendaTime time={set(date, { hours: 12, minutes: 55 })} />
                ...
                <StyledAgendaRow tracks={agendaParams.numTracks}>
                  <AgendaTime time={set(date, { hours: 13, minutes: 45 })} />
                ...
                <StyledAgendaRow tracks={agendaParams.numTracks}>
                  <AgendaTime time={set(date, { hours: 14, minutes: 50 })} />
                ...
                <StyledAgendaRow>
                  <AgendaTime time={set(date, { hours: 16, minutes: 15 })} />
                  <AgendaSession
                ...
                <StyledAgendaRow>
                  <AgendaTime time={set(date, { hours: 16, minutes: 50 })} />
                  <AgendaSession fullWidth>
                    <StyledTrackHeader>
                      Afterparty
                      <br />
                ...
                <StyledAgendaRow>
                  <AgendaTime time={set(date, { hours: 19, minutes: 0 })} />
                  <AgendaSession fullWidth>
