...
export default withPageMetadata(() => (
  <Page
    ...
    description={'Code of Conduct for ' + Conference.Name + '.'}
  >
    <h1>Code of Conduct</h1>

    <p>
      All attendees, speakers, sponsors and volunteers at our conference are
      required to agree with the following code of conduct. We are expecting
      cooperation from all participants to help ensuring a safe, welcoming and
    ...
    <h2>Need Help?</h2>
    <p>
      Email <a href={Conference.ContactEmail}>{Conference.ContactEmail}</a> or
      call {Conference.EmergencyPhoneNumber}.
    </p>
    ...
    <p>
      ...
      conference <em>without a refund</em> at the discretion of the conference
      organisers.
    </p>
    ...
    <p>
      ...
      appearance, body size, race, ethnicity, religion, sexual images in public
    ...
    <p>
      Attendance at {Conference.Name} is at your own risk and by entering{' '}
      {Conference.Name} you agree not to hold {Conference.Name}, it’s organisers
      ({Conference.Organiser}), partners, subsidiaries or parent companies
    ...
    <p>
      <small>
        <em>
          ...
          <br />
          "Attendance Is At Your Own Risk" section has been additionally added
          to the licensed "Conference Code of Conduct".
        </em>
      </small>
    </p>
  </Page>
