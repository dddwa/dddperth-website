...
export default withPageMetadata(() =>
  <Page title="Code of Conduct" description="Code of Conduct for DDD Perth.">
    ...
    <p style={{textAlign: "center", fontSize: "150%", textDecoration: "underline"}}><strong>Organisers will enforce this code throughout the event.</strong></p>

    <h2>Need Help?</h2>
    <p>Email <a href={Conference.ContactEmail}>{Conference.ContactEmail}</a> or call {Conference.EmergencyPhoneNumber}.</p>

    <h2>The Quick Version</h2>
    <p>Our conference is dedicated to providing a harassment-free conference experience for everyone, regardless of gender, gender identity and expression, age, sexual orientation, disability, physical appearance, body size, race, ethnicity, or religion (or lack thereof). We do not tolerate harassment of conference participants in any form. Sexual language and imagery is not appropriate for any conference venue, including talks, workshops, parties, Twitter and other online media. Conference participants violating these rules may be sanctioned or expelled from the conference <em>without a refund</em> at the discretion of the conference organisers.</p>
    ...
    <p>
        <small>
            <em>
                ...
                "Attendance Is At Your Own Risk" section has been additionally added to the licensed "Conference Code of Conduct".
            </em>
        </small>
