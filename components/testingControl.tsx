    ...
    return <div id="testing-control">
      <Panel>
        ...
        {this.state.on && <Panel.Body>
          ...
          <a className="agenda btn" style={btnStyle} onClick={() => this.setDateTo(Conference.AgendaPublishedFrom)}>Agenda published</a><br />
          <a className="conference btn" style={btnStyle} onClick={() => this.setDateTo(Conference.Date)}>On the day</a><br />
          <a className="sponsors btn" style={btnStyle} onClick={() => Conference.Sponsors = From2017.Sponsors}>Add sponsors</a><br />
          <a className="btn btn-secondary" style={btnStyle} onClick={() => this.reset()}>Reset</a><br />
          <p className="text-center">Now: <code>{dateTimeProvider.now().format("DD/MM/YYYY h:mma")}</code></p>
        </Panel.Body>}
      </Panel>
    </div>;
  }
