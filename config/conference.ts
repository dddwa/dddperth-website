...
const registrationOpenFrom = zonedTimeToUtc('2024-11-23T08:00:00', '+10:30')
const registrationOpenUntil = hideDate ? null : sub(date, { hours: 14, minutes: 45 })
const presentationSubmissionsOpenFrom = zonedTimeToUtc('2024-08-01T08:00:00', '+10:30')
const presentationSubmissionsOpenUntil = zonedTimeToUtc('2024-09-06T23:59:59', '+10:30')
const votingOpenFrom = zonedTimeToUtc('2024-09-10T17:00:00', '+10:30')
const votingOpenUntil = zonedTimeToUtc('2024-09-29T23:59:59', '+10:30')
const agendaPublishedFrom = zonedTimeToUtc('2024-10-05T17:00:00', '+10:30')
