...
Faqs.push({
    ...
    Answer: (
        <Fragment>
            ...
            <a href={'mailto:' + Conference.ContactEmail}>contact us</a> to pay by invoice (EFT or credit card).
        </Fragment>
    ),
    Category: 'tickets',
})
...
Faqs.push({
    ...
    Answer: (
        <Fragment>
            We are always looking for volunteers and sometimes looking for organisers! It takes a lot of effort to
            organise a volunteer-run conference like {Conference.Name}. Shoot us an email at{' '}
            <a href={'mailto:' + Conference.ContactEmail}>{Conference.ContactEmail}</a> and we can work with you to
            figure out the best way to assist.
        </Fragment>
    ),
})
...
Faqs.push({
    ...
    Answer: (
        <Fragment>
            ...
            recruiting opportunity based on being attended by people that don't normally get to go to conferences. It's
            also a great chance to give back and support the local software community. We have various levels of
            sponsorship available with various benefits and price points. We have a sponsorship prospectus that will be
            provided on request that explains detailed benefits and impact of sponsorship and the difference between the
            various levels; if you would like a copy{' '}
...
Faqs.push({
    ...
    AnswerWithoutParagraph: (
        <Fragment>
            <p>
                {Conference.Name} is organised by DDD WA Inc. a non-profit organisation set up to create inclusive
                events for the WA software community. {Conference.Name} {Conference.Instance} is organised by:
            </p>
            <ul>
                <li>
